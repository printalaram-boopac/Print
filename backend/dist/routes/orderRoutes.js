...
router.post('/', authMiddleware_1.authenticate, async (req, res) => {
    try {
        ...
        const { designId, templateId, quantity, unitPrice, shippingAddress, phone, customerName, coupleName, familyName, greetingText, isExpress, theme, occasion, photoUrl, designTitle, shippingName, city, state, pincode, } = req.body;
